...
object HandlingFailure extends App {
  ...
  // if you get the html page form the connection, print it to the console i.e. call renderHTML
  ...
  for {
    ...
    htmlPage <- connection.getSafe("/mnt")
  } renderHTML(htmlPage)

  /*
  try {
    connection = Http.getConnection(host,port)
    try {
